...
- Each converging sequence has unique limit and is bounded.
  ...
  >	  and let $m=max\{m_{y},m_{z}\}$^[m is a number at which both of the above equalities work. The equalities will work if we take their intersection, in this case it is the maximum of these values].
